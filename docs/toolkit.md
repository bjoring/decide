...
This function turns the lights on at full brightness. See `lights().man_set` for
setting the lights to a specific brightness.
...
### Playing Sound Files with Aplayer
````javascript
