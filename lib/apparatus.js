...
//
// constructor(params, callback): params - dict of parameters for the
// component. callback(err, data) - called by the component to emit a PUB message.
//
// pub(msg): called whenever the apparatus recieves PUB message. msg - the data
// of the message
//
...
// clients expect a response, so this method MUST BE CALLED. Call with no
// arguments to indicate a successful operation.
//
var apparatus = {
    ...
    keys: [keys, { device: "/dev/input/event1"}],
...
// route req messages. All components need to expose a
